...
echo "Install some I/O packages to load various image file formats from disk"
sudo apt-get -y install libjpeg-dev libtiff5-dev libjasper-dev libpng-dev

echo "Install some I/O packages to load various video file formats"
sudo apt-get -y install libavcodec-dev libavformat-dev libswscale-dev libv4l-dev
sudo apt-get -y install libxvidcore-dev libx264-dev

echo "Install GTK dev library for highgui"
...
echo "Optimise OpenCV operations"
sudo apt-get -y install libatlas-base-dev gfortran

echo "Install HDF5 datasets and Qt GUIs"
...
echo "Install Python header files"
